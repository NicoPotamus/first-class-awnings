    ...
    <main className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          {/* Contact Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 place-items-center">
            {/* Call Now Card */}
            <div className="bg-white rounded-lg shadow-md p-8 text-center md:col-span-2 w-full max-w-md">
              <div className="mb-6">
